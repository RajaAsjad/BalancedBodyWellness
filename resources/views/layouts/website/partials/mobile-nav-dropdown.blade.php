...
<div class="mobile-menu__dropdown" data-mobile-nav-dropdown>
    <button type="button"
        ...
        <span class="mobile-menu__dropdown-label">{{ $label }}</span>
        <svg class="mobile-menu__dropdown-chevron" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
            <path d="m6 9 6 6 6-6" />
        </svg>
    </button>
    <div class="mobile-menu__dropdown-panel" id="{{ $panelId }}" aria-hidden="true">
        <div class="mobile-menu__dropdown-panel-inner">
