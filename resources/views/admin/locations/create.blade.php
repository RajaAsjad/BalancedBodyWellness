...
<section class="content bbw-crud-theme" style="margin-bottom: 0;">
	<div class="bbw-form-card">
		...
		<div class="bbw-form-body">
			<form action="{{ route('location.store') }}" id="regform" method="post" enctype="multipart/form-data" accept-charset="utf-8">
				@csrf
				<div class="bbw-form-inner">
					@include('admin.locations.partials.form-fields')

					<div class="bbw-form-actions">
						<button type="submit" class="bbw-btn-submit"><i class="fa fa-plus"></i> Add Location</button>
					</div>
				</div>
			</form>
		</div>
...
$(function () {
	...
	$('#regform').validate({
		rules: { name: 'required', image: 'required' },
		errorClass: 'error',
		validClass: 'valid',
		errorElement: 'span',
