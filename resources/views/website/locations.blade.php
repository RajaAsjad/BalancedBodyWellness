...
@section('content')
    ...
    <section class="page-hero page-hero--wellness page-hero--location" aria-labelledby="location-hero-heading">
        <div class="container-pns">
            ...
            <h1 class="page-hero__title" id="location-hero-heading">IV Wellness Studio in Los Angeles</h1>
            <p class="page-hero__note">Visit our calming, spa-inspired studio for IV therapy, peptide therapy, and vitamin injections — medical oversight with the comfort you deserve.</p>
        </div>
    </section>
